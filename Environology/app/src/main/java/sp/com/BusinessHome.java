...
public class BusinessHome extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View view = inflater.inflate(R.layout.business_home, container, false);

        sendmessage = view.findViewById(R.id.sendmessage);
        sendmessage.setOnClickListener(onSendMessage);
    ...
    private View.OnClickListener onSendMessage = new View.OnClickListener() {
        ...
        public void onClick(View v) {
            ...
            Intent i = new Intent(getActivity(), BusinessSendMessage.class);
            startActivity(i);
        }
    };
